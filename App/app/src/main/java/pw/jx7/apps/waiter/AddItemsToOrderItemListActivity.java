...
import pw.jx7.apps.waiter.Adapters.ItemGroupsListAdapter;
import pw.jx7.apps.waiter.Adapters.ItemsListForOrderAdapter;
...
public class AddItemsToOrderItemListActivity extends AppCompatActivity {
    ...
    private void loadItemsList() {
        ...
        String url = CustomTools.url("json/app")+"?connectorCode="+connectorCode+"&itemsList=1&group_id="+group_id;
